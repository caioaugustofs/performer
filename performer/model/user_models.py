...
class User_Workout_Sessions:
    ...
    total_workout_duration_seconds: Mapped[int] = mapped_column(
        default=None, nullable=True
    )  # Tempo total ativo
    total_rest_duration_seconds: Mapped[int] = mapped_column(
        default=None, nullable=True
...
class Progress_Tracking:
    ...
    peso: Mapped[float] = mapped_column(default=None, nullable=True)
    altura: Mapped[float] = mapped_column(default=None, nullable=True)
    muscle_mass_percentage: Mapped[float] = mapped_column(
        default=None, nullable=True
    )
    body_fat_percentage: Mapped[float] = mapped_column(
        default=None, nullable=True
    )
    IMC: Mapped[float] = mapped_column(default=None, nullable=True)
    waist_circumference: Mapped[float] = mapped_column(
        default=None, nullable=True
    )
    body_measurements: Mapped[dict] = mapped_column(
        JSON, default=None, nullable=True
    )
